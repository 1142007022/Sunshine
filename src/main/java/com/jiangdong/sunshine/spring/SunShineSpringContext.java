...
public abstract class SunShineSpringContext {
        ...
        try {
            ...
            while (dirs.hasMoreElements()) {
                ...
                if ("file".equals(protocol)) {
                    ...
                    findAndAddClassesInPackageByFile(packageName, filePath, isContinue, classes);
                    ...
                    try {
                        ...
                        throw new SunshineSpringException(e.getMessage(), e);
                    }
                }
            }
        } catch (Exception e) {
     ...
     * @param classes
     */
    private static void findAndAddClassesInPackageByFile(String packageName, String packagePath, final boolean isContinue, List<Class<?>> classes) {
        // 获取此包的目录 建立一个File
        ...
        File[] dirFiles = dir.listFiles(new FileFilter() {
            ...
            public boolean accept(File file) {
                return (isContinue && file.isDirectory()) || (file.getName().endsWith(".class"));
            }
        });
        // 循环所有文件
        for (File file : dirFiles) {
            // 如果是目录 则继续扫描
            if (file.isDirectory()) {
                findAndAddClassesInPackageByFile(packageName + "." + file.getName(), file.getAbsolutePath(), isContinue, classes);
            } else {
